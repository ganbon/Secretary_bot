...
run_button = tk.Button(root, text="サーバ起動", width = 20, font = ('MSゴシック',17),
                       fg = '#223a70', bg = '#fef4f4', command = lambda:com.run_button_clicked(run_button))
run_button.pack()
quit_button = tk.Button(root, text = "サーバ停止", width = 20,font = ('MSゴシック',17),
                        fg = '#223a70', bg = '#fef4f4', command = lambda:com.quit_button_clicked(run_button))
quit_button.pack()
app_button = tk.Button(root, text = "アプリ起動", width = 20, font = ('MSゴシック',17),
